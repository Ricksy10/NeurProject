...
CLASS_LABELS = [
    {
        "label_id": 0,
        "label_name": "chlorella",
        "folder_name": "class_chlorella",
        "is_priority": True,
    },
    {"label_id": 1, "label_name": "debris", "folder_name": "class_debris", "is_priority": False},
    {
        "label_id": 2,
        "label_name": "haematococcus",
        "folder_name": "class_haematococcus",
        "is_priority": False,
    },
    {
        "label_id": 3,
        "label_name": "small_haematococcus",
        "folder_name": "class_small_haemato",
        "is_priority": False,
    },
    {
        "label_id": 4,
        "label_name": "small_particle",
        "folder_name": "class_small_particle",
        "is_priority": False,
    },
]
...
def discover_subjects(data_root: str, split: str = "train") -> Dict[str, Dict[str, Any]]:
    """
...
def create_subject_folds(
    subject_ids: List[str], class_labels: List[int], n_splits: int = 5, seed: int = 42
